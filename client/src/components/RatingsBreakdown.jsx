...
export default function RatingsBreakdown({ ratings, userId }) {
    ...
    <div className="flex-col flex items-center ">
      ...
      <Link to={`/user/${userId}/ratings/5`}>
        <h2 className="flex w-64 md:w-96 border-2 border-black   justify-between lg:text-md text-xs">
          ...
          <Rating readOnly size="small" value={5} isVerified={true} />
        </h2>
      </Link>
      <Link to={`/user/${userId}/ratings/4.5`}>
        <h2 className="flex w-64 md:w-96 border-2 border-black  justify-between lg:text-md text-xs">
      ...
      <Link to={`/user/${userId}/ratings/3.5`}>
        <h2 className="flex w-64 md:w-96 border-2 border-black  justify-between lg:text-md text-xs">
      ...
      <Link to={`/user/${userId}/ratings/2.5`}>
        <h2 className="flex w-64 md:w-96 border-2 border-black  justify-between lg:text-md text-xs">
      ...
      <Link to={`/user/${userId}/ratings/1.5`}>
        <h2 className="flex w-64 md:w-96 border-2 border-black  justify-between lg:text-md text-xs">
